# Definicion de funcion para ajustar y calcular bondad de ajuste para cada distribucion 
# utilizando metodo de L-Momentos y Maxima Verosimilitud
AjusteUnivariado <- function(x = x, p.valor = umbral.p.valor, configuracion = configuracion.ajuste.univariado) {
